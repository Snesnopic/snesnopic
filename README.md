...
- **Master's Degree in Computer Science** (Ongoing)  
  University of Pisa  
...
- **Full Stack Developer**  
  *TypeScript, Angular, Java, Red Hat Systems, MySQL*  
  Building scalable enterprise applications with robust frontend and backend integration.

- **App Developer**
  *Android, iOS*  
  Developing mobile applications with focus on usability and performance.

- **Junior Micro-controllers Developer**  
  *ESP32, STM32, C++*  
  Prototyping embedded systems and IoT solutions.
...
- Uses the Taptic Engine to translate text input into distinct Morse code vibration patterns.
- Optimized for energy efficiency and accessibility standards. Fully customizable emissions.
